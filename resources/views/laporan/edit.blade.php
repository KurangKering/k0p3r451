...
<div class="panel panel-default">
 ...
 <form class="form-horizontal" action="{{ route('ambil_simpanan.update', $ambil->id) }}" method="POST">
  @csrf
  {{ method_field("PATCH") }}
  {{ Form::hidden('val_sisa', $ambil->user->sisa_simpanan) }}
  <div class="form-group">
    <label class="control-label col-lg-2">NIP</label>
    <div class="col-lg-10">
      <div class="input-group">
        {{ Form::text('nip', $ambil->user->nip, ['class' => 'form-control', 'readonly' => true]) }}
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      {{ Form::text('name', $ambil->user->name, ['class' => 'form-control', 'readonly' => true]) }}
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      {{ Form::text('sisa_simpanan', rupiah($ambil->user->sisa_simpanan), ['class' => 'form-control', 'readonly' => true]) }}
    </div>
  </div>
  <div class="form-group">
