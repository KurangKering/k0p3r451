...
@section('header-title', 'Tambah Simpanan Wajib')
...
<div class="panel panel-default">
 ...
 @endif
 <form class="form-horizontal" action="{{ route('simpanan_wajib.store') }}" method="POST">
  @csrf
  {{ Form::hidden('id') }}
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      {{ Form::number('jumlah', '50000', ['class' => 'form-control']) }}
    </div>
  </div>
